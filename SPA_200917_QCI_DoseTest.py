...
overlap = 2.5   # overlap between snail and lumped cap (for EBPG stitching errors)
...
#Yale chip dimensions 
#chipx = 11.0*mm 
#chipy = 5.0*mm

#Standard JPC chip dimensions 
#chipx = 11.0*mm 
#chipy = 9.0*mm
...
Res1length = 640*um #length of the resonator segement between the end of the taper and the cap 
...
#--------Script params---------------------------
design_name = 'SPA_200918_DoseTestCells' #this is the name of the gds file that gets output
DoseTestBool = 0
